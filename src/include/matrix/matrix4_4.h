...
template <typename T>
inline T det(const Matrix4_4<T>& a);
template <typename T>
inline Matrix4_4<T> cofact(const Matrix4_4<T>& a);
template <typename T>
inline Matrix4_4<T> adj(const Matrix4_4<T>& a);
...
struct Matrix4_4
{
    ...
    constexpr Matrix4_4<T>(const Matrix4_4<T>& o) : x_0(o.x_0), y_0(o.y_0), z_0(o.z_0), w_0(o.w_0), x_1(o.x_1), y_1(o.y_1), z_1(o.z_1), w_1(o.w_1), x_2(o.x_2), y_2(o.y_2), z_2(o.z_2), w_2(o.w_2), x_3(o.x_3), y_3(o.y_3), z_3(o.z_3), w_3(o.w_3) { }
    constexpr Matrix4_4<T>(const T _x_0, const T _y_0, const T _z_0, const T _w_0, const T _x_1, const T _y_1, const T _z_1, const T _w_1, const T _x_2, const T _y_2, const T _z_2, const T _w_2, const T _x_3, const T _y_3, const T _z_3, const T _w_3) : x_0(_x_0), y_0(_y_0), z_0(_z_0), w_0(_w_0), x_1(_x_1), y_1(_y_1), z_1(_z_1), w_1(_w_1), x_2(_x_2), y_2(_y_2), z_2(_z_2), w_2(_w_2), x_3(_x_3), y_3(_y_3), z_3(_z_3), w_3(_w_3) { }
    constexpr Matrix4_4<T>(): x_0(0), y_0(0), z_0(0), w_0(0), x_1(0), y_1(0), z_1(0), w_1(0), x_2(0), y_2(0), z_2(0), w_2(0), x_3(0), y_3(0), z_3(0), w_3(0) { }

    inline Vector4<T> col0() const { return Vector4<T>{ x_0,x_1,x_2,x_3 }; }
    inline Vector4<T> col1() const { return Vector4<T>{ y_0,y_1,y_2,y_3 }; }
    inline Vector4<T> col2() const { return Vector4<T>{ z_0,z_1,z_2,z_3 }; }
    inline Vector4<T> col3() const { return Vector4<T>{ w_0,w_1,w_2,w_3 }; }
    inline Vector4<T> row0() const { return Vector4<T>{ x_0,y_0,z_0,w_0 }; }
    inline Vector4<T> row1() const { return Vector4<T>{ x_1,y_1,z_1,w_1 }; }
    inline Vector4<T> row2() const { return Vector4<T>{ x_2,y_2,z_2,w_2 }; }
    inline Vector4<T> row3() const { return Vector4<T>{ x_3,y_3,z_3,w_3 }; }

    inline void operator=(const Matrix4_4<T>& a) { x_0 = a.x_0; y_0 = a.y_0; z_0 = a.z_0; w_0 = a.w_0; x_1 = a.x_1; y_1 = a.y_1; z_1 = a.z_1; w_1 = a.w_1; x_2 = a.x_2; y_2 = a.y_2; z_2 = a.z_2; w_2 = a.w_2; x_3 = a.x_3; y_3 = a.y_3; z_3 = a.z_3; w_3 = a.w_3; }
    inline void operator+=(const Matrix4_4<T>& a) { x_0 += a.x_0; y_0 += a.y_0; z_0 += a.z_0; w_0 += a.w_0; x_1 += a.x_1; y_1 += a.y_1; z_1 += a.z_1; w_1 += a.w_1; x_2 += a.x_2; y_2 += a.y_2; z_2 += a.z_2; w_2 += a.w_2; x_3 += a.x_3; y_3 += a.y_3; z_3 += a.z_3; w_3 += a.w_3; }
    inline void operator-=(const Matrix4_4<T>& a) { x_0 -= a.x_0; y_0 -= a.y_0; z_0 -= a.z_0; w_0 -= a.w_0; x_1 -= a.x_1; y_1 -= a.y_1; z_1 -= a.z_1; w_1 -= a.w_1; x_2 -= a.x_2; y_2 -= a.y_2; z_2 -= a.z_2; w_2 -= a.w_2; x_3 -= a.x_3; y_3 -= a.y_3; z_3 -= a.z_3; w_3 -= a.w_3; }
    inline void operator*=(const Matrix4_4<T>& a)
    {
        Vector4<T> r0 = row0();
        Vector4<T> r1 = row1();
        Vector4<T> r2 = row2();
    ...
    inline void operator/=(const T a) { x_0 /= a; y_0 /= a; z_0 /= a; w_0 /= a; x_1 /= a; y_1 /= a; z_1 /= a; w_1 /= a; x_2 /= a; y_2 /= a; z_2 /= a; w_2 /= a; x_3 /= a; y_3 /= a; z_3 /= a; w_3 /= a; }
    inline Matrix4_4<T> operator-() const { return Matrix4_4<T>{ x_0, x_1, x_2, x_3, y_0, y_1, y_2, y_3, z_0, z_1, z_2, z_3, w_0, w_1, w_2, w_3 }; }
    inline Matrix4_4<T> operator~() const { return adj(*this) / det(*this); }
};

template <typename T>
inline Matrix4_4<T> operator+(const Matrix4_4<T>& a, const Matrix4_4<T>& b)
{
    return Matrix4_4<T>
    {
...
inline Vector4<U> operator*(const Matrix4_4<T>& a, const Vector4<U>& b)
{
    return Vector4<U>{ a.row0() ^ b, a.row1() ^ b, a.row2() ^ b, a.row3() ^ b };
}

template <typename T>
inline Matrix4_4<T> operator*(const Matrix4_4<T>& a, const T b)
{
    return Matrix4_4<T>
    {
 ...
 * **/
template <typename T>
inline T minor(const Matrix4_4<T>& a, const uint8_t e)
{
    switch (e)
    {
 ...
 * **/
template <typename T>
inline T det(const Matrix4_4<T>& a) { return ((a.x_0 * minor(a, 0)) - (a.y_0 * minor(a, 1))) + ((a.z_0 * minor(a, 2)) - (a.w_0 * minor(a, 3))); }
 ...
 * **/
template <typename T>
inline Matrix4_4<T> cofact(const Matrix4_4<T>& a) { return Matrix4_4<T>{ minor(a,0), -minor(a,1), minor(a,2), -minor(a,3), -minor(a,4), minor(a,5), -minor(a,6), minor(a,7), minor(a,8), -minor(a,9), minor(a,10), -minor(a,11), -minor(a,12), minor(a,13), -minor(a,14), minor(a,15) }; }
 ...
 * **/
template <typename T>
inline Matrix4_4<T> adj(const Matrix4_4<T>& a) { return -cofact(a); }
